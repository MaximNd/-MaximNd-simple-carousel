...
var Slider = function () {
    function Slider() {
        ...
        var indicatorsContainer = (0, _helpers.getDef)(document.querySelector(sliderSelector + ' ' + options.indicators), document.querySelector(sliderSelector + ' ' + _config2.default.indicators));
